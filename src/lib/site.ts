...
export const landingPages: Record<string, LandingPageData> = {
  home: {
    ...
    title: "中国可用的稳定 VPN 推荐",
    description:
      "如果你现在只是想找个在中国能正常用、别老掉线、还能先免费用个三天的 VPN，这页先给你看最要紧的，不跟你绕。",
    metaTitle: "中国可用的稳定 VPN 推荐｜支持试用、兼顾隐私与多设备",
    metaDescription:
      "面向中文用户的 VPN 推荐页面，重点介绍中国网络环境下更稳的连接体验、3 天免费试用、4 台设备支持和无日志隐私保护。",
    keywordText: "先看稳不稳，再看试用、设备和隐私，基本就够你做第一轮判断了。",
    searchIntent: "适合还没完全想清楚，但又不想被一堆参数看晕的人。",
    openingAnswer: [
      "大多数人第一次找 VPN，想要的其实很简单：能连上，别老掉，手机电脑都能用，最好还能先试几天再说。要是这几个点都不行，后面讲再多都没用。",
      "所以这页不打算跟你堆一堆术语。先把最容易影响体验的几件事摊开说，你看完就知道自己是该先免费用个三天，还是继续去看别的。",
    ],
    evaluationPoints: [
      {
    ...
    recommendationReason:
      "因为对大多数人来说，先把会不会掉线、试用顺不顺、设备够不够用这几件事看明白，比先看一大堆专业词有用得多。",
    finalTitle: "别先纠结太久，先免费用个三天再说",
    finalBody:
      "你要是真想知道它适不适合自己，最靠谱的办法还是拿自己的网络和设备跑几天。能不能用、顺不顺手、值不值得继续，三天下来基本就有感觉了。",
  ...
  china: {
    ...
    title: "中国好用 VPN 推荐",
    description:
      "很多人搜中国好用 VPN，其实不是想看品牌故事，只是想知道一件事：在中国到底能不能稳用，会不会动不动就掉。",
    metaTitle: "中国好用 VPN 推荐｜适合中国网络环境，支持免费试用",
    metaDescription:
      "想找中国好用的 VPN？这页重点介绍中国网络环境下的稳定连接、3 天免费试用、4 台设备支持和无日志隐私保护。",
    keywordText: "你先别管宣传写得多厉害，先看它在中国用的时候稳不稳。",
    searchIntent: "适合已经把需求缩得很窄：只想知道在中国到底好不好用的人。",
    openingAnswer: [
      "人在中国找 VPN，最烦的不是功能少，而是今天能连、明天不行；刚连上没多久，切个 Wi‑Fi 或换成流量又掉了。真遇到这种情况，前面说得再漂亮也没意义。",
      "所以这页不跟你绕。要是你最关心的就是在中国稳不稳，那先看连接表现、网络切换、常用场景和试用期够不够用，基本就够了。",
    ],
    evaluationPoints: [
      {
    ...
    recommendationReason:
      "因为中国环境下，最值钱的信息不是功能表，而是你用的时候会不会掉、会不会卡、会不会隔三差五得重连。",
    finalTitle: "在中国能不能稳用，别靠猜，先自己跑几天",
    finalBody:
      "真想知道中国好不好用，最直接的办法还是先免费用个三天。把你平时最常用的网络和设备都试一遍，结果一般很快就出来了。",
  ...
  trial: {
    ...
    searchIntent: "适合最怕买完才后悔，想先把体验试明白的人。",
    openingAnswer: [
      "试用最大的好处，不是省这点钱，而是你终于不用只听别人怎么说。拿自己的手机、电脑、Wi‑Fi、流量都跑一遍，合不合适其实很快就知道。",
      "很多人试用没试明白，是因为只开了一次就算了。真要试，就按自己平时怎么用去试：晚上高峰试一下，网络切换试一下，多个设备一起装上再试一下。",
    ],
    evaluationPoints: [
      {
    ...
    finalBody:
      "你不用急着现在就下长期决定。先把自己的手机、电脑、Wi‑Fi 和流量都试一遍，三天下来，值不值得继续，基本就八九不离十了。",
  ...
  nolog: {
    ...
    searchIntent: "适合不一定懂很多术语，但确实比较在意隐私的人。",
    openingAnswer: [
      "很多人一开始选 VPN，先看的都是能不能连上。这个当然没错。但你要是准备长期用，后面迟早会开始在意一件事：用完之后会留下多少东西，心里踏不踏实。",
      "无日志值钱的地方，不是把自己说得多神，而是让你在长期使用时少一层顾虑。不过它也不能脱离现实，还是得和稳定性、试用体验一起看。",
    ],
    evaluationPoints: [
      {
        title: "先别把无日志想得太玄",
    ...
    finalBody:
      "你不用把它理解得特别复杂。要是你本来就比较在意少留记录，那就把无日志和稳定性一起确认掉，再决定要不要继续用，会更踏实。",
